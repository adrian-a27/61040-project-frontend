...
export default class PostConcept {
  ...
  async create(author: ObjectId, content: string, songId: string) {
    const _id = await this.posts.createOne({ author, content, songId });
  ...
  private sanitizeUpdate(update: Partial<PostDoc>) {
    ...
    const allowedUpdates = ["content", "sampleStart", "sampleEnd"];
